...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "strikes 2 to 5 times. Contact. Punch."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_VINE_WHIP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes with\n"
            "slender, whiplike vines. Contact. 10% to drop Defense."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_FURY_ATTACK] =
    {
        .name = COMPOUND_STRING("Fury Jab"),
        .description = COMPOUND_STRING(
            "Jabs the foe 2 to 5 times\n"
            "with a sharp beak, horns, etc. Contact."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_WATER_GUN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Squirts water to attack. MegaLauncher."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_SURF] =
    {
        ...
        .description = COMPOUND_STRING(
            "Creates a huge wave that crashes down on everyone."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_WATERFALL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Charges with speed that scales\n"
            "even waterfalls. 20% to flinch."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_BARRAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Pieces of shrapnel are hurled at the\n"
            "foe, hitting 2 to 5 times. Ballistic."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_FURY_SWIPES] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "claws, etc., 2 to 5 times. Contact."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_ARM_THRUST] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "strike the foe 2 to 5 times. Contact."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_ROCK_BLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hurls boulders that hit\n"
            "2 to 5 times in a row. Ballistic."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_AURA_SPHERE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that cannot be evaded. Ballistic. Pulse."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
    ...
    [MOVE_MAGNET_BOMB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "strikes without fail. Ballistic."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_STEEL,
        .accuracy = 0,
    ...
    [MOVE_WILD_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "An electrical tackle with a 10% recoil. Contact."),
        .effect = EFFECT_RECOIL,
        .power = 90,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_POWER_UP_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A hard punch with a 100% to raise\n"
            "the user's Attack. Punch. Contact."),
        .effect = EFFECT_HIT,
        .power = 20,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
