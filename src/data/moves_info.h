...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A flurry of cosmic {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}punch{COLOR WHITE}{SHADOW DARK_GRAY}es\n"
    ...
    [MOVE_VISE_GRIP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "mandibles for "BINDING_TURNS" turns.\n"
           " {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_BUG,
    ...
    [MOVE_CUT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Cuts with sharp\n"
            "scythes, claws, etc. Has a +2 crit ratio. Contact. Slice."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_BIND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "for "BINDING_TURNS" turns. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_ROLLING_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A fast {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}kick{COLOR WHITE}{SHADOW DARK_GRAY} delivered from\n"
            "a speedy spin. 100% to raise Speed.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_BODY_SLAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A full-body slam. Uses\n"
            "Def over Atk for damage\n"
            "calculation. 20% to paralyze. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
    ...
    [MOVE_WRAP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            BINDING_TURNS" times with vines, etc. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_MEDITATE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_CALM_MIND},
        .battleAnimScript = gBattleAnimMove_Concentrate,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = STAT_CHANGE_EFFECT_PLUS,
            .spAtk = 1,
        }),
    ...
    [MOVE_FOCUS_ENERGY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "critical-hit ratio by 2 stages."),
    ...
    [MOVE_CLAMP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "foe for "BINDING_TURNS" turns. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_CONSTRICT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "100% to drop Speed. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_HIGH_JUMP_KICK] =
    {
        .name = COMPOUND_STRING("Jump Kick"),
        .description = COMPOUND_STRING(
            "A jumping knee {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}kick{COLOR WHITE}{SHADOW DARK_GRAY}.\n"
            "Suffers 1/3 crash damage on miss.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .power = 130,
        .effect = EFFECT_RECOIL_IF_MISS,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_BARRAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Pieces of shrapnel are\n"
            "hurled at the target\n"
            "2 to 5 times.\n"
            "Ballistic."),
        .effect = EFFECT_HIT,
        .power = 25,
    ...
    [MOVE_DIZZY_PUNCH] =
    {
        .name = COMPOUND_STRING("Dizzy Fists"),
        .description = COMPOUND_STRING(
            "Hits with rhythmic {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}punches{COLOR WHITE}{SHADOW DARK_GRAY}.\n"
            "5% chance to confuse each hit.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 35,
        .type = TYPE_NORMAL,
    ...
    [MOVE_FURY_SWIPES] =
    {
        ...
        .description = COMPOUND_STRING(
            "Rakes with claws or\n"
            "similar, hitting 2 to 5 times.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact, Slice{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_SUPER_FANG] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks with fangs, cutting\n"
            "the foe's remaining HP in half.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact, Bite{COLOR WHITE}{SHADOW DARK_GRAY}."),
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spins to remove traps and\n"
            "hazards. 100% to raise Speed. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
    ...
    [MOVE_WHIRLPOOL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Partial-traps and hurts the foe in\n"
    ...
    [MOVE_ROCK_TOMB] =
    {
        ...
        .description = COMPOUND_STRING(
            "Prevents the foe's movement\n"
            "with rocks. 100% to drop Speed."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_METAL_SOUND] =
    {
        .name = COMPOUND_STRING("Metal Clang"),
        .description = COMPOUND_STRING(
            "Emits a horrible {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}sound{COLOR WHITE}{SHADOW DARK_GRAY}\n"
            "like scraping metals."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_STEEL,
        .accuracy = 100,
        ...
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_MetalClang,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_BIDE_NEW] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = {
            .reflectDamage.damagePercent = 125,
            .reflectDamage.damageCategories = 1u << DAMAGE_CATEGORY_PHYSICAL | 1u << DAMAGE_CATEGORY_SPECIAL,
        },
        .ignoresProtect = B_UPDATED_MOVE_FLAGS < GEN_5,
        .makesContact = TRUE,
    ...
    [MOVE_ZEN_HEADBUTT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Focuses willpower into a headbutt.\n"
            "20% chance to flinch.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 80,
    ...
    [MOVE_DOUBLE_HIT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "a tail, or the like.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Double- strike. Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 35,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_PSYSHOCK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A peculiar attack that hits\n"
            "Def or SpD, whichever weaker."),
        .effect = EFFECT_CATACLYSM,
        .power = 90,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_HEAVY_SLAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "user's weight. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_NEW_HEAVY_SLAM,
        .power = 1,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_FAIRY_WIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stirs up a fairy {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}wind{COLOR WHITE}{SHADOW DARK_GRAY}\n"
            "to strike the foe."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FAIRY,
    ...
    [MOVE_BABY_DOLL_EYES] =
    {
        .name = COMPOUND_STRING("Doll Eyes"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_INFESTATION] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "attacked for "BINDING_TURNS" turns. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_LASER_FOCUS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Boosts accuracy, and ensures\n"
            "the next move to be a critical hit."),
    ...
    {
        .name = COMPOUND_STRING("Bad Tantrum"),
        .description = COMPOUND_STRING(
            "Stomps about angrily.\n"
            "BP is 2x if last turn's move failed.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
    ...
    [MOVE_BODY_PRESS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Uses Def over Atk for\n"
            "damage calculation. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_BODY_PRESS,
        .power = 90,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_AXE_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A heel {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}kick{COLOR WHITE}{SHADOW DARK_GRAY} that causes 1/3 crash damage on miss.\n"
    ...
    [MOVE_TRAILBLAZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Leaps suddenly out of grass\n"
            "to strike. 100% chance to\n"
            "raise Speed. {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_CHILLING_WATER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Douses the foe in ice-cold\n"
            "water. 100% to lower Atk and SpA."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_TEMPER_FLARE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes, spurred by desperation.\n"
            "BP is 2x if last turn's move failed.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_STOMPING_TANTRUM,
        .power = 75,
    ...
    [MOVE_SUPERCELL_SLAM] =
    {
        .name = COMPOUND_STRING("Stormy Slam"),
        .description = COMPOUND_STRING(
            "An electric {COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}kick{COLOR WHITE}{SHADOW DARK_GRAY}.\n"
            "Suffers 1/3 crash damage on miss.\n"
            "{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR5}Contact{COLOR WHITE}{SHADOW DARK_GRAY}."),
        .effect = EFFECT_RECOIL_IF_MISS,
        .power = 130,
