...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_LOKIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STRIKER, ABILITY_NONE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Lokix"),
        .cryId = CRY_LOKIX,
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .abilities = { ABILITY_RUN_AWAY, ABILITY_PICKUP, ABILITY_FAMILIAL_BOND },
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_BATTLE_ONLY, 25, SPECIES_MAUSHOLD_FOUR, CONDITIONS({IF_PID_OUTSIDE_CODE_MODULO_100_GT, 0})},
                                {EVO_LEVEL_BATTLE_ONLY, 25, SPECIES_MAUSHOLD_THREE, CONDITIONS({IF_PID_OUTSIDE_CODE_MODULO_100_EQ, 0})}),
    },
