...
static const struct WindowTemplate sBottleCapStatWindowTemplate =
{
    .bg = 2,
    .tilemapLeft = 17,
    .tilemapTop = 1,
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_CARE_PACKAGE]    = {COMPOUND_STRING("Care Package"),    CursorCb_CarePackage},
    [MENU_HEAD_HOME]       = {COMPOUND_STRING("Head Home"),       CursorCb_HeadHome},
};
