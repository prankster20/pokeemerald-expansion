...
const u8 gText_PkmnTooFrugalForItem[] = _("{STR_VAR_1} is too frugal\nto hold {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnTooFastidiousForItem[] = _("{STR_VAR_1} is too fastidious\nto hold {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NostalgicMovesCantBeForgotten[] = _("Nostalgic POKéMON won't\nforget those moves.");
const u8 gText_EclecticNeedsSameCategoryMove[] = _("Eclectic POKéMON need\na balanced moveset.");
