...
static void BuyMenuPrintSmall(u8 windowId, const u8 *text, u8 x, u8 y, s8 speed, u8 colorSet);
...
static void BuyMenuPrintItemDescriptionAndShowItemIcon(s32 item, bool8 onInit, struct ListMenu *list)
{
    ...
    BuyMenuPrintSmall(WIN_ITEM_DESCRIPTION, description, 3, 0, 0, COLORID_NORMAL);
}
...
static void BuyMenuPrint(u8 windowId, const u8 *text, u8 x, u8 y, s8 speed, u8 colorSet)
{
    AddTextPrinterParameterized4(windowId, FONT_NORMAL, x, y, -1, 0, sShopBuyMenuTextColors[colorSet], speed, text);
}

static void BuyMenuPrintSmall(u8 windowId, const u8 *text, u8 x, u8 y, s8 speed, u8 colorSet)
{
    AddTextPrinterParameterized4(windowId, FONT_SMALL, x, y, -1, 0, sShopBuyMenuTextColors[colorSet], speed, text);
}
