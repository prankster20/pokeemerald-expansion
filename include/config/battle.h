...
#define B_SNOW_WARNING              FALSE      // In Gen9+, Snow Warning will summon snow instead of hail.
...
#define B_OVERWORLD_SNOW                FALSE      // In Gen9+, overworld Snow will summon snow instead of hail in battle.
