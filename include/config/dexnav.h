...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x468 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x470 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x472 // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_UNUSED_0x40F9 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_UNUSED_0x40FA // Steps for finding hidden Pokémon
