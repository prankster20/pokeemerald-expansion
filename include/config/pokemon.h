...
#define P_MIRROR_HERB_PRE_EVO_EGG_MOVES TRUE                     // If TRUE, a party Pokémon holding a Mirror Herb can inherit Egg Moves from the Egg Move pool of its earliest pre-evolution.
