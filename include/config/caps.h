...
#define B_RARE_CANDY_CAP                TRUE // Runtime hard caps also apply to Rare Candies and Exp. Candies
...
// EV Cap Configs
#define B_EV_CAP_TYPE                   EV_CAP_FLAG_LIST // [EV_CAP_NONE, EV_CAP_FLAG_LIST, EV_CAP_VARIABLE, EV_CAP_NO_GAIN]
#define B_EV_CAP_VARIABLE               0 // Event variable used when B_EV_CAP_TYPE is EV_CAP_VARIABLE.

#define B_EV_ITEMS_CAP                  TRUE // EV-boosting items obey both progression EV caps.
