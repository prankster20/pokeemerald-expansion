...
extern const u8 gText_PkmnTooFrugalForItem[];
extern const u8 gText_PkmnTooFastidiousForItem[];
...
extern const u8 gText_NostalgicMovesCantBeForgotten[];
extern const u8 gText_EclecticNeedsSameCategoryMove[];
...
extern const u8 gText_BWXNature[];
extern const u8 gText_BWHatchedAtYZ_XNature[];
extern const u8 gText_BWHatchedSomewhereAt_XNature[];
extern const u8 gText_BWMetAtYZ_XNature[];
extern const u8 gText_BWMetSomewhereAt_XNature[];
extern const u8 gText_BWFatefulEncounter_XNature[];
extern const u8 gText_BWProbablyMetAt_XNature[];
extern const u8 gText_BWObtainedInTrade_XNature[];
