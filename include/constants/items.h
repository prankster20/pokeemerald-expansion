...
enum __attribute__((packed)) Item
{
    ...
    ITEM_CATCH_UP_CANDY = 888,
    ITEM_PERSONALITY_MINT = 889,
    ITEM_PERSONALITY_SELECTOR_MINT = 890,

    // Thematic Nature-group Mints. Each group has Random, Split, and Select grades.
    ...
    ITEM_RISKY_RANDOM_MINT = 897,
    ITEM_RISKY_SPLIT_MINT = 898,
    ITEM_RISKY_SELECT_MINT = 899,
    ITEM_OG25_RANDOM_MINT = 900,
    ITEM_OG25_SPLIT_MINT = 901,
    ITEM_OG25_SELECT_MINT = 902,
    ITEM_CUTE_RANDOM_MINT = 903,
    ITEM_CUTE_SPLIT_MINT = 904,
    ITEM_CUTE_SELECT_MINT = 905,
    ITEM_MEAN_RANDOM_MINT = 906,
    ITEM_MEAN_SPLIT_MINT = 907,
    ITEM_MEAN_SELECT_MINT = 908,
    ITEM_SILLY_RANDOM_MINT = 909,
    ITEM_SILLY_SPLIT_MINT = 910,
    ITEM_SILLY_SELECT_MINT = 911,
    ITEM_ELITE_RANDOM_MINT = 912,
    ...
    ITEM_NATURE_EXPANSION_MINT = 917,

    ITEMS_COUNT,
    ITEM_FIELD_ARROW = ITEMS_COUNT,
};

enum NatureMintGroup
{
    MINT_GROUP_BEGINNER,
    MINT_GROUP_EXPERT,
    MINT_GROUP_RISKY,
...
#define GROUP_MINT_SECONDARY_ID(group, grade) ((group) * NUM_MINT_GRADES + (grade))
