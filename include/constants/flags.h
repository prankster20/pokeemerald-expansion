...
#define FLAG_DUSK_DIAL_PAUSE_TIME  0x264
...
#define FLAG_UNUSED_0x8E5                           (SYSTEM_FLAGS + 0x85) // Used by the Repel Charm
#define FLAG_EXP_MAX_ON                             (SYSTEM_FLAGS + 0x86)
#define FLAG_POWER_TRAINER_ON                       FLAG_EXP_MAX_ON // Compatibility alias
#define FLAG_EXPEDITED_TRAINING                     (SYSTEM_FLAGS + 0x87)
