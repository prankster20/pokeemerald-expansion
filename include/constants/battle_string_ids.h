...
enum StringID
{
    ...
    STRINGID_PKMNNOTKEENONLEARNINGMOVE,
    ...
    STRINGID_ARROGANTFEELINGCONFIDENT,
    STRINGID_BENEVOLENTBOOSTSHEALING,
    STRINGID_TEMPESTUOUSCHASESSTORMS,
    STRINGID_TERRITORIALGUARDSTERRITORY,
    STRINGID_VAINFEELINGHAUGHTY,
    STRINGID_VANITYBROKEN,
    STRINGID_SUPERSTITIONBUILDING,
    STRINGID_SUPERSTITIOUSTOOSCARED,
    STRINGID_SCROUNGERFOUND,
    STRINGID_PUGNACIOUSSPARRED,
    STRINGID_COUNT
};
