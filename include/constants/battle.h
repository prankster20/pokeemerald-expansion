...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_DISABLE_TIMER,               disableTimer,                  (u32, B_DISABLE_TIMER + 4)) \
    F(VOLATILE_ENCORE_TIMER,                encoreTimer,                   (u32, B_ENCORE_TIMER + 4)) \
...
#define MOVE_RESULT_FOE_ENDURED_AFFECTIONATE (1 << 17)
